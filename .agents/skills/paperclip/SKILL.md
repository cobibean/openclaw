...
For blocked state template, dedup rule, and escalation table: `skills/paperclip/references/blocked-state-quickref.md`

For session reset triggers (when to reset vs resume, per-role rules): `/home/cobi/bot/shared/policies/session-reset-triggers.md`
