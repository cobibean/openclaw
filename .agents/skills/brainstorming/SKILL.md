...
5. **Write design doc** — save to `workspace/plans/YYYY-MM-DD-<topic>-design.md` and commit
6. **Transition to implementation** — invoke writing-plans skill to create implementation plan

## The Process

**Understanding the idea:**
- Check out the current project state first (files, docs, recent memory)
...
**Documentation:**
- Write the validated design to `workspace/plans/YYYY-MM-DD-<topic>-design.md`
